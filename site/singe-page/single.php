...
->getOne('blogs','blogs.id, blogs.title, blogs.image, description , full_description, counter, categories.name, date');
        ...
        <main class="position-relative">
            <div class="container">
                <div class="entry-header entry-header-1 mb-30 mt-50">
                    <div class="entry-meta meta-0 font-small mb-30"><a href="category.html"><span class="post-cat bg-success color-white"><?= $blog['name'] ?></span></a></div>
                    <h1 class="post-title mb-30">
                        <?= $blog['title'] ?>
                    </h1>
                    <div class="entry-meta meta-1 font-x-small color-grey text-uppercase">
                        <span class="post-by">توسط <a href="author.html">مهتاب رضایی </a> و <a href="author.html">سعید شمس</a></span>
                ...
                <div class="row mb-50">
                    <div class="col-lg-8 col-md-12">
                        ...
                        <figure class="single-thumnail mb-30">
                            <img src="../../attachment/imgs/news-23.jpg" alt="">
                            <div class="credit mt-15 font-small color-grey">
                                <i class="ti-credit-card ml-5"></i><span>تصویر از: unsplash.com</span>
                            </div>
                        </figure>
                        <div class="single-excerpt">
                            <p class="font-large">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی</p>
                        </div>
                        <div class="entry-main-content">
                            ...
                            <figure class="wp-block-gallery columns-3">
                                <ul class="blocks-gallery-grid">
                                    <li class="blocks-gallery-item"><a href="#"><img class="border-radius-5" src="../../attachment/imgs/thumbnail-1.jpg" alt=""></a></li>
                                    <li class="blocks-gallery-item"><a href="#"><img class="border-radius-5" src="../../attachment/imgs/thumbnail-2.jpg" alt=""></a></li>
                                    <li class="blocks-gallery-item"><a href="#"><img class="border-radius-5" src="../../attachment/imgs/thumbnail-10.jpg" alt=""></a></li>
                                </ul>
                            </figure>
                            ...
                            <div class="wp-block-image">
                                <figure class="alignleft is-resized">
                                    <img class="border-radius-5" src="../../attachment/imgs/thumbnail-14.jpg">
                        ...
                        <div class="author-bio border-radius-10 bg-white p-30 mb-40">
                            <div class="author-image mb-30">
                                <a href="author.html"><img src="../../attachment/imgs/authors/author.png" alt="" class="avatar"></a></div>
                        ...
                        <div class="comments-area">
                            ...
                            <div class="comment-list">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="../../attachment/imgs/authors/author-2.png" alt="">
                                        </div>
                                        <div class="desc">
                                            <p class="comment">
                            ...
                            <div class="comment-list">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="../../attachment/imgs/authors/author-3.png" alt="">
                                        </div>
                                        <div class="desc">
                                            <p class="comment">
                            ...
                            <div class="comment-list">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="../../attachment/imgs/authors/author-16.png" alt="">
                                        </div>
                                        <div class="desc">
                                            <p class="comment">
                            ...
                            <div class="post-block-list post-module-6">
                                <div class="last-comment mb-20 d-flex wow fadeIn">
                                    <span class="item-count vertical-align">
                                        <a class="red-tooltip author-avatar" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Azumi - 985 posts"><img src="../../attachment/imgs/authors/author-14.png" alt=""></a>
                                    </span>
                                ...
                                <div class="last-comment d-flex wow fadeIn">
                                    <span class="item-count vertical-align">
                                        <a class="red-tooltip author-avatar" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Johny - 445 posts"><img src="../../attachment/imgs/authors/author-3.png" alt=""></a>
                                    </span>
                                    <div class="alith_post_title_small">
