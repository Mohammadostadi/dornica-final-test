                    ...
                    <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets/imgs/news-24.jpg)">
                        <div class="position-midded">
                            <div class="entry-meta meta-0 font-small mb-30">
                                <a href="category.html"><span class="post-cat bg-success color-white">در تماس باشید</span></a>
                            </div>
                ...
                <div class="row mb-50">
                    ...
                    <div class="col-lg-8 col-md-12">
                        ...
                        <div class="entry-main-content mt-50">
                            <h3>تبلیغات</h3>
                            <hr class="wp-block-separator is-style-wide">
                            <p>لطفاً مستقیماً با ما در SiteName.ticksy.com برای کمپین های بزرگ یا منحصر به فرد برای درخواست های پیشنهادی و اطلاعات قیمت دیگر به SiteName@yahoo.com ایمیل بزنید. </p>
