                    ...
                    <div class="border p-3 rounded">
                        ...
                        <form class="row g-3 needs-validation" action="" method="post" novalidate enctype="multipart/form-data"
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <span class="text-danger">*</span>
                                <input type="text" dir="ltr" class="form-control date" name="date" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-lg-12">
                                ...
                                <span class="text-danger">*</span>
                                <textarea type="text" class="form-control" name="full_description" rows="6" required></textarea>
                                <div class="invalid-feedback">
