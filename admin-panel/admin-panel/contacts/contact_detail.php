                            ...
                            <div class="card border shadow-none w-100">
                                <div class="card-body">
                                    <div class="container d-flex justify-content-center">
                                        ...
                                        if (isset($_GET['id'])) {
                                            $contact = $db->where('contacts.id', $id)
                                                ->getOne('contacts', "name, description, contacts.setdate, contacts.status");
                                        }
                                                    ...
                                                    <div class="media-body u-shadow-v18 g-bg-secondary g-pa-30">
                                                        <div class="g-mb-15">
                                                            <h5 class="h5 g-color-gray-dark-v1 mb-0">
                                                                <?= $contact['name'] ?></h5>
                                                            <span
                                                                class="g-color-gray-dark-v4 g-font-size-12"><?= jdate('Y/m/d', strtotime($contact['setdate'])) ?></span>
                                                        </div>
                                                        <div>
                                                            <p class="text-start"><?= $contact['description'] ?></p>
                                                        </div>
                                                        <div class="container">
                                                            <form class="row d-flex justify-content-between" action=""
                                                                ...
                                                                <div class="col-md-6 mt-3">
                                                                    <select name="status" id="status"
                                                                        class="form-select">
                                                                        <option <?= $contact['status'] == 2 ?> value="2">
                                                                            تایید</option>
                                                                        <option <?= $contact['status'] == 1 ?> value="1">رد
                                                                        </option>
                                                                        <option <?= $contact['status'] == 0 ?> value="0">در
                                                                            حال بررسی</option>
                                                                    </select>
                                                                </div>
